  ...
  return (
    <>
      <div
        ...
        className={
          sideBar
            ? "sideBarDark darkIconOuter sunIcon"
            : "darkIconOuter sunIcon"
        }
      >
        <svg
      ...
      <div
        onClick={() => clickedOuter()}
        className={
          sideBar
            ? "sideBarDark darkIconOuter moonIcon"
            : "darkIconOuter moonIcon"
        }
      >
        <svg
